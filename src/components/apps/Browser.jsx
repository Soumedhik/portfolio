...
const TitleBar = ({ toggleBrowser, isFullscreen, setIsFullscreen, minimizeWindow, browserRef }) => (
...
const AddressBar = ({ name }) => (
  <div className="flex bg-neutral-800 w-full h-10 border-neutral-700 border-b-[1.5px] mt-1 items-center">
    ...
    <div className="flex items-center gap-3 pr-4">
      ...
      <img src="/images/options/dots.png" alt="options" className="h-4 w-4 rotate-90 opacity-60" />
    </div>
  </div>
);
