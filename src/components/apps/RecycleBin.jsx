...
const RecycleBin = ({ isRecycleOpen, toggleRecycle, bounds, minimizeWindow, isMinimized }) => {
  ...
  return (
    ...
    >
      <Draggable handle=".title-bar" nodeRef={explorerRef} bounds={bounds} disabled={isFullscreen}>
        <motion.div
          ref={explorerRef}
          className="window bg-black overflow-hidden border-neutral-700 border-[1.5px] pointer-events-auto rounded-xl"
          layout
          animate={{
            width: isFullscreen ? '100vw' : '70.5rem',
            height: isFullscreen ? '100vh' : '39rem',
          ...
          <div className="title-bar">
            <div className="text-white h-9 flex justify-between select-none">
              <div className="m-1 ml-4 font-normal flex items-center gap-2">
                <span className="material-symbols-outlined text-yellow-400">delete</span>
