...
const SystemTray = ({ isVisible, onClose, windows11Features, addNotification }) => {
  ...
  const runningApps = [
    { name: 'Portfolio Explorer', cpu: '12%', memory: '245 MB' },
    { name: 'VS Code', cpu: '8%', memory: '312 MB' },
    { name: 'Calculator', cpu: '2%', memory: '45 MB' },
    { name: 'Browser', cpu: '15%', memory: '678 MB' }
  ];
